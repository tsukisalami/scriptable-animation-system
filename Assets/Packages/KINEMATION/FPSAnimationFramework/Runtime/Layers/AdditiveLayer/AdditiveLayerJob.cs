    ...
    public struct AdditiveLayerJob : IAnimationJob, IAnimationLayerJob
    {
        ...
        public void UpdatePlayableJobData(AnimationScriptPlayable playable, float weight)
        {
            ...
            if (_recoilAnimation != null && _recoilAnimation.RecoilData != null)
            {
                ...
                var pivotOffset = Vector3.Lerp(data.hipPivotOffset, data.aimPivotOffset, job.aimWeight);
                
                job.recoil.rotation = Quaternion.Euler(_recoilAnimation.OutRot);
                job.recoil.position = _recoilAnimation.OutLoc + (job.recoil.rotation * pivotOffset - pivotOffset);
            }
